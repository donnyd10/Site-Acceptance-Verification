<template>
  <div class="min-h-screen bg-gradient-to-b from-blue-50 to-white py-8 px-4 sm:px-6 lg:px-8">
    <!-- Form container -->
    <div class="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100">
      <!-- Form header with accent bar -->
      <div class="bg-gradient-to-r from-blue-600 to-blue-800 py-4 px-6">
        <h2 class="text-2xl font-bold text-white">Site Acceptance Verification</h2>
      ...
      <form @submit.prevent="submitForm" class="p-6 space-y-6">
        ...
        <div class="bg-blue-50 rounded-lg border border-blue-100 overflow-hidden">
          ...
          >
            ...
            <svg class="w-5 h-5 transform transition-transform" :class="{ 'rotate-180': generalDetailsExpanded }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
          </button>
          
          <div v-if="generalDetailsExpanded" class="p-4 space-y-4 animate-fade-in">
        ...
        <div v-for="(section, sectionKey) in sections" :key="sectionKey" class="bg-blue-50 rounded-lg border border-blue-100 overflow-hidden">
          <button 
          ...
          >
            ...
            <svg class="w-5 h-5 transform transition-transform" :class="{ 'rotate-180': section.expanded }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
          </button>
          ...
          <div v-if="section.expanded" class="p-4 space-y-4 animate-fade-in">
            ...
            <div v-for="(field, key) in section.fields" :key="key" class="mb-4 p-3 bg-white rounded-lg">
        ...
        <div class="bg-blue-50 rounded-lg border border-blue-100 p-4">
          ...
          <div class="flex items-center justify-center w-full">
            <label class="flex flex-col w-full h-32 border-2 border-dashed border-blue-300 hover:border-blue-500 rounded-lg cursor-pointer transition-all duration-200 hover:bg-blue-100">
              <div class="flex flex-col items-center justify-center pt-7">
                <svg class="h-8 w-8 text-blue-400 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                </svg>
                <p class="pt-1 text-sm tracking-wider text-blue-500 group-hover:text-blue-700">
          ...
          <div v-if="imagePreview" class="mt-4 relative inline-block">
            <img :src="imagePreview" alt="Image Preview" class="w-full max-w-xs h-48 object-contain rounded-lg shadow-md border border-blue-200 bg-white">
            <button @click="removeImage" class="absolute -top-3 -right-3 bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold shadow-md hover:bg-red-700 transition-colors duration-200 z-10" title="Remove Image">
              ✕
            </button>
          </div>
