<template>
  ...
  <form
    ...
    class="pb-18 sm:pb-18 md:p-6 lg:p-6 max-w-3xl mx-auto bg-gradient-to-br from-blue-50 to-gray-50 shadow-xl rounded-xl border border-gray-200"
  >
    <!-- Form header section -->
      ...
      <div v-if="section.expanded" class="mt-4 space-y-4 animate-fade-in">
        ...
        <div v-if="sectionKey === 'physicalVerification'" class="mt-4">
          <label class="block font-medium text-gray-700 mb-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 inline-block mr-1 text-blue-600"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
              <path
    ...
    <div class="mb-6 bg-white p-5 rounded-xl shadow-sm border border-gray-100">
      ...
      <div class="flex items-center justify-center w-full">
        <label
          class="flex flex-col w-full h-32 border-2 border-dashed border-gray-300 hover:border-blue-500 rounded-lg cursor-pointer transition-all duration-200 hover:bg-blue-50"
        >
...
export default {
  ...
  methods: {
    ...
    // Move this line outside the methods object
    ...
    validateForm() {
      ...
      // Validate Verification Sections
